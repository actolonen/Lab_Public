...
chromConverter installation using a micromamba environment:

1.  Activate micromamba environment
2.  micromamba install r-remotes
3.  activate R
4.  confirm micromamba R is running:
    1.  R.home('bin')
5.  Install chromConverter: remotes::install_github("[https://github.com/ethanbass/chromConverter/")](https://github.com/ethanbass/chromConverter/"))
