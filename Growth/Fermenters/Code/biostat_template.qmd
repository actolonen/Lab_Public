...
total_time_F1 = round(max(data_F1$Hours), 2);
total_time_F3 = round(max(data_F3$Hours), 2);
my_message = glue("The total time for F1 was {total_time_F1} hours and for F3 was {total_time_F3} hours.");
print(my_message);
